    ...
    return (
        <div className = "accordion-container">
            <AccordionMUI className = {AccordianClasses.root}>
                <AccordionSummary expandIcon={<ExpandMoreIcon style = {{fill : '#000000'}} fontSize = 'large'/>} >
                    <button 
                        onClick = {() => {
                            removeInput(id)
                        }}
                    ...
                    <button 
                        ...
                        {...drag}
                    >
                        <DragHandleOutlinedIcon fontSize = 'large' style = {{fill : '#000000'}} />
                    </button>
                    
                </AccordionSummary>
                <AccordionDetails>
                    <div className='all_inputs' style = {{margin: 'auto'}}>
                    <div className = 'input-container' style = {{display : 'block', overflow: 'auto', height: 'fit-content', width: 'fit-content', marginBottom : '0.5vh'}}>
                        ...
                        <div className = "dates" style = {{display : 'block', width : 'fit-content', height : 'fit-content', margin : 'auto', marginTop: '3vh'}}>
                            ...
                            <div className = 'date-current'>
                                <FormControlLabel
                                    control = {
                                        <Checkbox style ={{color: "#000000",}} checked = {checked} size = 'medium' onChange = {(e)=> {
                                            if (e.target.checked) {
                                                let end = null
                                                setEnd(end)
                                                let checked = true
                        ...
                        <div style = {{height : "fit-content", width : 'fit-content', margin : 'auto', paddingTop : '1vh'}}>
                                ...
                                <div style = {{width: "45vw", marginTop: "2vh"}}>
                                    <Editor
                                        ...
                                        editorStyle = {{minHeight:"10vh", border : "1px solid lightgrey", fontFamily : "Open Sans", color : '#000000', backgroundColor: 'white'}}
